...
class Connection : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vg.Connection) */ {
 public:
  Connection();
  virtual ~Connection();
...
inline ::google::protobuf::uint32 Connection::next() const {
  // @@protoc_insertion_point(field_get:vg.Connection.next)
  return next_;
}
inline void Connection::set_next(::google::protobuf::uint32 value) {
...
inline ::google::protobuf::int32 Connection::score() const {
  // @@protoc_insertion_point(field_get:vg.Connection.score)
  return score_;
}
inline void Connection::set_score(::google::protobuf::int32 value) {
...
inline void Visit::set_name(const char* value, size_t size) {
